...
//        if (strategy.equals(DamengConnectorConfig.LogMiningStrategy.CATALOG_IN_REDO)) {
...
//                "END;";
    ...
    static String logMinerContentsQuery(DamengConnectorConfig connectorConfig, String logMinerUser)
    {
        ...
        query.append("SELECT SCN, SQL_REDO, OPERATION_CODE, TIMESTAMP, XID, CSF, TABLE_NAME, SEG_OWNER, OPERATION, USERNAME, ROW_ID, ROLL_BACK ");
